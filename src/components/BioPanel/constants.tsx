...
export const EnglishBioPanelText = () => {
    return (
        <p className="text">
            ...
            Hi! I'm <span className="text-bold">Simon Ou</span>. I'm currently attending full-time studies at the
            University of Waterloo and working part-time as a full-stack software engineer. I love tinkering with
            software and have experience with serverless applications, web development, socket infrastructure,
            cloud architecture, and game development.<br/><br/>
...
export const FrenchBioPanelText = () => {
    return (
        <p className="text">
            ...
            temps à l'Université de Waterloo et travaille à temps partiel comme ingénieur logiciel full-stack. Ça me
            dit de bricoler les logiciels, et j'ai de l'expérience avec les applications serverless, le développement
            Web, les résaux de socket, l'architecture du cloud, et la conception des jeux.<br/><br/>
