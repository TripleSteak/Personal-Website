...
export const EnglishBioPanelText = () => {
    return (
        <p className="text">
            ...
            of Waterloo. I love tinkering with software and have experience with serverless applications, web
            development, socket infrastructure, cloud architecture, and game development.<br/><br/>
...
export const FrenchBioPanelText = () => {
    return (
        <p className="text">
            ...
            l'Université de Waterloo. Ça me dit de bricoler des logiciels, et j'ai de l'expérience avec les
            applications serverless, le développement Web, les résaux de socket, l'architecture du cloud, et la
            conception des jeux.<br/><br/>
